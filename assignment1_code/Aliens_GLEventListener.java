...
public class Aliens_GLEventListener implements GLEventListener {
    ...
    public void initialise(GL3 gl) {
        ...
        textures.add(gl, "Wall", "textures/WallMedieval.jpg");
        textures.add(gl, "Gray", "textures/gray.jpg");
        ...
        ground = new Model("Ground", groundMesh, new Mat4(1), groundShader, groundMaterial, light1, light2, sl, camera, textures.get("Gray"), textures.get("Gray"));
        ...
        Texture[] et2HeadTextures = {textures.get("Gray"), textures.get("Gray")};
