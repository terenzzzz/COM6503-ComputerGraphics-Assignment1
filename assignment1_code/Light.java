...
public class Light {
  ...
  private float ambient_strength;
  private float specular_strength;
  private float diffuse_strength;
  ...
  public void setLight(GL3 gl,Float color){
    shader.use(gl);
    shader.setFloat(gl,"lightColor",color);
  }
